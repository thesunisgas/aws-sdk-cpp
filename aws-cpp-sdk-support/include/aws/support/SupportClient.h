...
namespace Model
{
   ...
   * <important> <ul> <li> <p>You must have a Business or Enterprise support plan to
   * use the AWS Support API. </p> </li> <li> <p>If you call the AWS Support API from
   * an account that doesn't have a Business or Enterprise support plan, the
   ...
   * </important> <p>The AWS Support service also exposes a set of <a
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * <code>expiryTime</code> returned in the response is when the set expires.
         ...
         * operation.</p> </li> </ul> <p>A successful <a>CreateCase</a> request returns an
         * AWS Support case number. You can use the <a>DescribeCases</a> operation and
         * specify the case number to get existing AWS Support cases. After you create a
         * case, you can use the <a>AddCommunicationToCase</a> operation to add additional
         * communication or attachments to an existing case.</p> <note> <ul> <li> <p>The
         * <code>caseId</code> is separate from the <code>displayId</code> that appears in
         * the <a href="https://console.aws.amazon.com/support">Support Center</a>. You can
         * use the <a>DescribeCases</a> operation to get the <code>displayId</code>.</p>
         ...
         * <a>DescribeCommunications</a> operation.</p><p><h3>See Also:</h3>   <a
